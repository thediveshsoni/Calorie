...
<form action="CalorieCount2" method="GET">
...
<div class="col-md-3">
 ...
 <div class="form-group mx-3 mt-4">
    ...
    <input type="text" class="form-control" name="l1" id="inputPassword2" placeholder="Quantity">
  </div>
...
<div class="form-group mx-sm-3 mt-4">
    <label for="inputPassword2" class="sr-only">quantity</label>
    <input type="text" class="form-control" name="l2" id="inputPassword2" placeholder="Quantity">
  </div>
</div>
...
<div class="form-group mx-sm-3 mt-4">
    <label for="inputPassword2" class="sr-only">quantity</label>
    <input type="text" class="form-control" name="l3" id="inputPassword2" placeholder="Quantity">
  </div>
</div>
</div>
