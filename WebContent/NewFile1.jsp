...
<form action="CalorieCount3" method="GET">
...
<div class="col-md-3">
 ...
 <div class="field">
        <select name="dinner1" id="dinner">
	<option value="9">Cooked Rice Plain</option>
	<option value="10">Cooked Rice Fried</option>
	<option value="11">Chapati</option>
	<option value="12">Dal</option>
	<option value="13">Vegetable</option>
	<option value="14">Salad</option>
	</select>

</div>
 <div class="form-group mx-3 mt-4">
    <label for="inputPassword2" class="sr-only">quantity</label>
    <input type="text" class="form-control" name="d1" id="inputPassword2" placeholder="Quantity">
  </div>
...
<div class="form-group mx-sm-3 mt-4">
    <label for="inputPassword2" class="sr-only">quantity</label>
    <input type="text" class="form-control" name="d2" id="inputPassword2" placeholder="Quantity">
  </div>
</div>
...
<div class="form-group mx-sm-3 mt-4">
    <label for="inputPassword2" class="sr-only">quantity</label>
    <input type="text" class="form-control" name="d3" id="inputPassword2" placeholder="Quantity">
  </div>
</div>
</div>
